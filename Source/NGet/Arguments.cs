...
namespace NGet
{
	public class Arguments
	{
		...
		public OptionSet LoggingAndInputFileArgumentOptionSet;
		public OptionSet StartupArgumentOptionSet;
		...
		public Arguments()
		{
			StartupArgumentOptionSet = new OptionSet
				{
			...
			LoggingAndInputFileArgumentOptionSet = new OptionSet
				{
		...
		public void ShowUsageFull()
		{
			...
			StartupArgumentOptionSet.WriteOptionDescriptions(DefaultOutput);
			DefaultOutput.WriteLine();

			DefaultOutput.WriteLine("Logging and input file:");
			LoggingAndInputFileArgumentOptionSet.WriteOptionDescriptions(DefaultOutput);
		}
