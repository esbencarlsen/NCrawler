...
namespace EPocalipse.IFilter
{
	...
	internal class FilterWrapper : IDisposable
	{
		...
		private readonly ClassFactoryWrapper _classFactoryWrapper;
		...
		{
			_classFactoryWrapper = classFactoryWrapper;
			Filter = filter;
		}
